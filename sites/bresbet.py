...
class BresbetAdapter(BaseSiteAdapter):
    ...
    def fill_registration(self, page: Page, client: Client, password: str) -> RegistrationResult:
        ...
        try:
            ...
            if "?account=signup" not in page.url and "?promo=" not in page.url:
                try:
            ...
            create_acc_btn = page.locator('button:has-text("Join Here"), button[data-test="create-account-button"], button[type="submit"]:has-text("Join")').first
